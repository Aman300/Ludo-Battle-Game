          ...
          children: [
            {
              name: "All",
              path: "/history/all",
              svgLogo: "m7.875 14.25 1.214 1.942a2.25 2.25 0 0 0 1.908 1.058h2.006c.776 0 1.497-.4 1.908-1.058l1.214-1.942M2.41 9h4.636a2.25 2.25 0 0 1 1.872 1.002l.164.246a2.25 2.25 0 0 0 1.872 1.002h2.092a2.25 2.25 0 0 0 1.872-1.002l.164-.246A2.25 2.25 0 0 1 16.954 9h4.636M2.41 9a2.25 2.25 0 0 0-.16.832V12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 12V9.832c0-.287-.055-.57-.16-.832M2.41 9a2.25 2.25 0 0 1 .382-.632l3.285-3.832a2.25 2.25 0 0 1 1.708-.786h8.43c.657 0 1.281.287 1.709.786l3.284 3.832c.163.19.291.404.382.632M4.5 20.25h15A2.25 2.25 0 0 0 21.75 18v-2.625c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125V18a2.25 2.25 0 0 0 2.25 2.25Z"
            },
            {
              name: "Game",
              path: "/history/games",
            ...
            },
            {
              ...
              svgLogo: "M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z"
            },
            
            {
              name: "Deposit",
              path: "/history/deposit",
              svgLogo: "M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z"
            },
            {
              name: "Referral",
              path: "/history/Referral",
              svgLogo: "M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z"
            },
            
            {
              name: "Penalty",
              path: "/history/penalty",
              svgLogo: "M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z"
            },
            {
              name: "Bonus",
              path: "/history/bonus",
              svgLogo: "M15 8.25H9m6 3H9m3 6-3-3h1.5a3 3 0 1 0 0-6M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"
            },
          ]
        },
        {
      ...
      const handleTabClick = (index) => {
        if(index === 1){
          if (openSubMenuIndex === index) {
            setOpenSubMenuIndex(null); // Toggle off if clicking the same item again
          } else {
            setOpenSubMenuIndex(index); // Toggle on for the clicked item          
          }
        }else{
          toggleMenu(false);
        }
                ...
                <div className='w-full py-4 border rounded-xl px-5 mb-4'>
                  ...
                  {menuItems.map((item, index) => (
                    <li key={index} className="border-b">
                      <Link
                        to={item.path}
                        className={`relative flex justify-between items-center h-11 focus:outline-none text-gray-600 hover:text-rose-600 pr-6`}
                        onClick={() => {
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <span className="ml-2 text-md tracking-wide truncate">{item.name}</span>
                        </div>

                        {item.children && item.children.length > 0 && openSubMenuIndex === index ? (
                          <div>
                      ...
                      {item.children && item.children.length > 0 && openSubMenuIndex === index && (
                        <ul className="pl-6 animate__animated animate__slideInLeft animate__faster">
                          {item.children.map((childItem, childIndex) => (
                            <li key={childIndex} className="border-b">
                              <Link
                                to={childItem.path}
                                className="relative flex justify-between items-center h-11 focus:outline-none text-gray-600 hover:text-rose-600 pr-6"
                                onClick={() => {
                                  // Handle click on child item if needed
                                  toggleMenu(false);
                                }}
                              >
                                <div className="flex items-center">
                                  ...
                                  <span className="ml-2 text-md tracking-wide truncate">{childItem.name}</span>
                                </div>
                                <div>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
